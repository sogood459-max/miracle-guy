...
// ═══════════════════════════════════════════════════════════════
{
  ...
  s.addTable([
    ...
    [{ text: "①", options: bd(false, true) },
      { text: "성장배경, 본인 성격의 장·단점", options: { align: "left", ...bd(false, true) } }],
    [{ text: "②", options: bd(true, true) },
      { text: "지원동기 (본교에 지원하게 된 이유와 응시 직종에 본인이 적합하다고 판단되는 이유)", options: { align: "left", ...bd(true, true) } }],
    [{ text: "③", options: bd(true, true) },
      { text: "입사 후 포부 및 직무 수행 계획", options: { align: "left", ...bd(true, true) } }],
    [{ text: "④", options: bd(true, false) },
      { text: "조직 내 갈등 상황과 이를 해결하기 위한 노력 및 극복했던 경험", options: { align: "left", ...bd(true, false) } }],
  ], {
...
// ═══════════════════════════════════════════════════════════════
{
  ...
  s.addTable([
    ...
    [{ text: "직무전문성", options: { align: "left", ...bd(false, true) } }, { text: "10점", options: bd(false, true) },
      { text: "5배수\n내외", options: { rowspan: 5, bold: true, fontSize: 12, fill: { color: CYAN2 } } }],
    [{ text: "지원동기 및 직업관", options: { align: "left", ...bd(true, true) } }, { text: "8점", options: bd(true, true) }],
    [{ text: "성장과정 및 활동경험", options: { align: "left", ...bd(true, true) } }, { text: "6점", options: bd(true, true) }],
    [{ text: "표현력", options: { align: "left", ...bd(true, false) } }, { text: "6점", options: bd(true, false) }],
...
// ═══════════════════════════════════════════════════════════════
{
  ...
  s.addTable([
    ...
    [{ text: "직무수행능력", options: { align: "left", ...bd(false, true) } }, { text: "20점", options: bd(false, true) },
      { text: "2배수\n내외", options: { rowspan: 5, bold: true, fontSize: 12, fill: { color: CYAN2 } } }],
    [{ text: "기본소양·태도", options: { align: "left", ...bd(true, true) } }, { text: "20점", options: bd(true, true) }],
    [{ text: "조직 이해도 및 적응력", options: { align: "left", ...bd(true, true) } }, { text: "15점", options: bd(true, true) }],
    [{ text: "발전가능성", options: { align: "left", ...bd(true, false) } }, { text: "15점", options: bd(true, false) }],
    [{ text: "합계", options: { align: "left", bold: true, fill: { color: CYAN2 } } },
